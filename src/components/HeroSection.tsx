            ...
            <div className={`space-y-8 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
              <div className="space-y-4">
                ...
                <p className="text-xl lg:text-2xl text-gray-600 leading-relaxed">
                  From Lead to Revenue – CRM + Sales Consulting that drives performance.
                </p>
              </div>
              ...
              <div className="flex items-center space-x-6 pt-8">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600">300+ businesses transformed</span>
                </div>
              ...
              <div className="relative">
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-6 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <span className="text-xs text-gray-500 ml-2">EaseMySaaS Analytics</span>
                  </div>
                  
                  {/* Dashboard Header */}
                  <div className="mb-4">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="text-sm font-bold text-gray-800">Revenue Dashboard</h3>
                      <span className="text-xs text-green-600 font-semibold">↗ +47%</span>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-xs font-semibold text-gray-700">Revenue Growth</span>
                  ...
                  <div className="mt-4 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-600">Active Pipeline</span>
                      <span className="text-xs font-semibold text-gray-800">₹8.2M</span>
                    </div>
                ...
                <div className="absolute -bottom-4 -left-4 w-14 h-14 bg-blue-500 rounded-full shadow-lg animate-float flex items-center justify-center" style={{ animationDelay: '1s' }}>
                  <div className="text-center">
                ...
                <div className="absolute top-1/2 -left-6 w-12 h-12 bg-purple-500 rounded-lg shadow-lg animate-float flex items-center justify-center" style={{ animationDelay: '2s' }}>
